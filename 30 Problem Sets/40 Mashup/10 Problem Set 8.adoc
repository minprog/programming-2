...
**Due: Friday, 16 December, at 23:59**
...
Toward CS50 IDE's top-left corner, within its "file browser" (not within a terminal window), control-click or right-click your `pset8` folder and then select *Download*. You should find that your browser has downloaded `pset8.zip`. Make sure to check whether the zip file contains your database `mashup.db`.
