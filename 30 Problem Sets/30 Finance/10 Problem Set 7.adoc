...
From there, ensure that the CS50 PHP library is world-readable.
...
And allow world access to the other directories that contain PHP files.
...
[source]
----
chmod a+r includes/*.php public/*.php views/*.php
chmod a+r vendor/library50-php-5/CS50/CS50.php
